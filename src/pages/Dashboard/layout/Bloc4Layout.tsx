  ...
  return (
    <section className="px-4 py-12 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
        ...
        <a
          href="#"
          className="text-gray-700 text-sm font-medium border-b border-gray-400 hover:text-[#f15a29] transition"
        >
          {pagesData?.bloc_3?.more_info}
        </a>
      </div>
      <div ref={sliderRef} className="keen-slider md:ml-20">
        {pagesData?.bloc_3?.cases?.map((item: any, index: number) => (
          <div key={index} className="keen-slider__slide rounded-xl ">
            <div className="bg-white rounded-xl w-full h-60 shadow-sm overflow-hidden mr-4">
